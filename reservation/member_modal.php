...
<form action = "add_member.php" method = "POST" role = "form-group" enctype='multipart/form-data'>
...
<div class="modal modal-primary fade" id="edit<?php echo $row['member_id']; ?>">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action = "edit_member.php" method = "POST" role="form" enctype = "multipart/form-data">
