...
<!--  form method -->
<form action = "add_room.php" role = "form" method = "POST">
...
<div class = "form-group">
<label>Start Time</label>
<input type = "time" name = "start_time" id = "s_time" class = "form-control">
</div>
<div class = "form-group">
<label>End Time</label>
<input type = "time" name = "end_time" id = "e_time" class = "form-control">
</div>
<div class = "form-group">
<label>Description</label>
