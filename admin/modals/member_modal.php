...
<form action = "server/addMember.php" method = "POST" role = "form-group" enctype='multipart/form-data'>
...
<div class="modal modal-primary fade" id="edit<?php echo $row['member_id']; ?>">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-body">
      <form action = "server/editMember.php" method = "POST" role="form" enctype = "multipart/form-data">
